...
M_E = unique(MeldId(unique(E_1_History_Location(:))));

for i=1:numel(M_E)
    M_E_percentage(i) = numel(find((MeldId(unique(E_1_History_Location(:))))==M_E(i)))./numel(unique(E_1_History_Location(:)));
end
M_E_percentage = M_E_percentage';

for i=1:numel(M_E)
    M_NE_percentage(i) = numel(find((MeldId(unique(NE_1_History_Location(:))))==M_E(i)))./numel(unique(NE_1_History_Location(:)));
end
M_NE_percentage = M_NE_percentage';

numel(E_1_History_Location(:))