...
% Train a classifier
trainedClassifier = fitensemble(predictors, response, 'Bag', 200, 'Tree', 'Type', 'Classification', 'PredictorNames', {'column_1' 'column_2' 'column_3' 'column_4' 'column_5'}, 'ResponseName', 'column_6', 'ClassNames', [-4 -3 -2 -1 0 1]);
