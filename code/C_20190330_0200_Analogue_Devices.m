...
examples_to_be_considered = min([size(fft_acc_x_window_fftshifted,1) size(fft_mag_x_window_fftshifted,1)]);
ML_data_fft_acc_mag_fftshifted = [
    fft_acc_x_window_fftshifted(1:examples_to_be_considered,:) ...
    fft_acc_y_window_fftshifted(1:examples_to_be_considered,:) ...
    fft_acc_z_window_fftshifted(1:examples_to_be_considered,:) ...
    fft_mag_x_window_fftshifted(1:examples_to_be_considered,:) ...
    fft_mag_y_window_fftshifted(1:examples_to_be_considered,:) ...
    fft_mag_z_window_fftshifted(1:examples_to_be_considered,:) ...
    status(40:total_length)];

%% without condensator acc and magenometer only with fftshifted

total_length1 = length(status1);
examples_to_be_considered1 = min([size(fft_acc_x1_window_fftshifted,1) size(fft_mag_x1_window_fftshifted,1)]);
ML_data_fft_1_acc_mag_fftshifted = [
    fft_acc_x1_window_fftshifted(1:examples_to_be_considered1,:) ...
    fft_acc_y1_window_fftshifted(1:examples_to_be_considered1,:) ...
    fft_acc_z1_window_fftshifted(1:examples_to_be_considered1,:) ...
    fft_mag_x1_window_fftshifted(1:examples_to_be_considered1,:) ...
    fft_mag_y1_window_fftshifted(1:examples_to_be_considered1,:) ...
    fft_mag_z1_window_fftshifted(1:examples_to_be_considered1,:) ...
